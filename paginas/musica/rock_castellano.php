...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/tumusica.css">
    ...
    <style type="text/css">
    .detalles {
  background-image: url('../imagenes/fondos/banner-rock-español.jpg');
}
  </style>
</head>
...
<div id="cuerpomusica" class="container-fluid">
   ...
   <center>
		...
		<div class="descripcion_detalle col-md-7 col-sm-7 col-xs-12">
       	 <div class="decrip">
            <h4>Rock En Castellano</h4>

            <strong>Descripcion :</strong>
 
           

            <p>Una gran cantidad de musica de rock en español aqui conoceras la musica de lo Abuelos De la Nada,Magneto, etc solo aqui en WEBSAYER</p>
          </div>
              ...
              <input type="text" id="buscador" class="form-control" data-tabla="rock_castellano">
...
$sql=$conexion->query("SELECT * FROM rock_castellano");
$contador=0;
