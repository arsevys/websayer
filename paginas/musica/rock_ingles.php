...
<head>
  ...
  <style type="text/css">
    .detalles {
  background-image: url('../imagenes/fondos/fondo-rock.jpg');
}
  </style>
</head>
...
<center>
		...
		<div class="descripcion_detalle col-md-7 col-sm-7 col-xs-12">
       	 <div class="decrip">
            <h4>Rock en Ingles</h4>

            <strong>Descripcion :</strong>
            <p>Aqui encontraras lo mejor de el rock en ingles como A-Ha,The Police,UB40,etc todo aqui en WEBSAYER</p>
              ...
              <input type="text" id="buscador" class="form-control" data-tabla="rock_ingles">
...
$sql=$conexion->query("SELECT * FROM rock_ingles");
$contador=0;
