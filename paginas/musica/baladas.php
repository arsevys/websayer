...
<center>
		<div class="descripcion_detalle col-md-7 col-sm-7 col-xs-12">
            ...
            <p>Lo mejor de las Baladas, aqui encontraras artistas como Juan Gabriel, Etc.Solo en WEBSAYER.</p>
          </div>
              ...
              <input type="text" id="buscador" class="form-control" data-tabla="baladas">
...
$sql=$conexion->query("SELECT * FROM baladas");
$contador=0;
