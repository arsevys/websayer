...
<head>
  ...
  <style type="text/css">
    .detalles {
  background-image: url('../imagenes/fondos/70.jpg');
}
  </style>
</head>
...
<center>
       	 ...
       	 <div class="decrip">
            <h4>Musica DE Ls 70</h4>

            <strong>Descripcion :</strong>
           
           

            <p>Lo mejor de los 70, aqui encontraras artistas como The Beatles Etc solo en WEBSAYER,</p>
          </div>
              ...
              <input type="text" id="buscador" class="form-control" data-tabla="70s">
...
$sql=$conexion->query("SELECT * FROM 70s");
$contador=0;
...
while ($a=mysqli_fetch_array($sql)) {
  ...
  $contador++;
     ...
     echo "<td width=100 id='es' style='padding:10px;'><img src='../imagenes/iconos/MONEDAS.png' width=30 height=30 > &nbsp; $a[precio]</td>";
     $id=$a[0];
     $titulo="\"$a[2]\"" ;
     $banda="\"$a[3]\"" ;
     $album="\"$a[4]\"" ;
