...
<head>
  ...
  <style type="text/css">
    .detalles {
  background-image: url('../imagenes/fondos/banner-cumbia.jpg');
}
  </style>
</head>
...
<div id="cuerpomusica" class="container-fluid">
   ...
   <center>
            ...
            <p>Lo mejor de la cumbia, aqui encontraras artistas como Nectar Etc solo en WEBSAYER,</p>
          </div>
              ...
              <input type="text" id="buscador" class="form-control" data-tabla="cumbia">
...
$sql=$conexion->query("SELECT * FROM cumbia");
$contador=0;
